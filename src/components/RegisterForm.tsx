...
import { UserIcon, EmailIcon, LockIcon, IdCardIcon } from './AnimatedIcons';

const RegisterForm = ({ handleRegister, switchToLogin }: { handleRegister: () => void; switchToLogin?: () => void }) => {
  return (
    <StyledWrapper>
      <div className="form-container">
        ...
        <form className="form">
          ...
          <div className="sign" onClick={handleRegister}>Sign up</div>
        </form>
